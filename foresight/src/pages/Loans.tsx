  ...
  return (
    ...
    <div className="w-full p-6 space-y-8 bg-slate-50 dark:bg-slate-950 min-h-screen max-h-screen flex flex-col text-slate-900 dark:text-slate-100 transition-colors duration-300">
     ...
     <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-slate-50 dark:bg-slate-950 px-2 flex-none">
       <div>
         <div className="text-2xl font-extrabold tracking-tight">Loan Portfolio</div>
           ...
           <table className="w-full text-left border-collapse relative">
             <thead>
               <tr className="text-xs font-semibold tracking-wider text-slate-400 dark:text-slate-500 border-b border-slate-100 dark:border-slate-800">
                 ...
                 <th className="sticky top-0 z-10 bg-slate-50/95 dark:bg-slate-800 py-4 px-6 backdrop-blur-sm">Loan ID</th>
                 <th className="sticky top-0 z-10 bg-slate-50/95 dark:bg-slate-800 py-4 px-6 backdrop-blur-sm">Customer ID</th>
                 <th className="sticky top-0 z-10 bg-slate-50/95 dark:bg-slate-800 py-4 px-6 backdrop-blur-sm">Bank Name</th>

                 <th className="sticky top-0 z-10 bg-slate-50/95 dark:bg-slate-800 py-4 px-6 backdrop-blur-sm">Loan Type</th>
                 <th className="sticky top-0 z-10 bg-slate-50/95 dark:bg-slate-800 py-4 px-6 backdrop-blur-sm text-right">Principal</th>
                 <th className="sticky top-0 z-10 bg-slate-50/95 dark:bg-slate-800 py-4 px-6 backdrop-blur-sm text-right">Outstanding Balance</th>
                 <th className="sticky top-0 z-10 bg-slate-50/95 dark:bg-slate-800 py-4 px-6 backdrop-blur-sm text-right">Interest Rate</th>
                 <th className="sticky top-0 z-10 bg-slate-50/95 dark:bg-slate-800 py-4 px-6 backdrop-blur-sm text-right">EMI (Monthly)</th>
                 <th className="sticky top-0 z-10 bg-slate-50/95 dark:bg-slate-800 py-4 px-6 backdrop-blur-sm text-right">Tenure</th>
                 <th className="sticky top-0 z-10 bg-slate-50/95 dark:bg-slate-800 py-4 px-6 backdrop-blur-sm text-right">DPD</th>
                 <th className="sticky top-0 z-10 bg-slate-50/95 dark:bg-slate-800 py-4 px-6 backdrop-blur-sm text-center">Status</th>
               </tr>
             </thead>
